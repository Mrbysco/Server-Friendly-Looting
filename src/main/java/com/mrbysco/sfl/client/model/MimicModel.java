...
public class MimicModel<T extends AbstractMimicEntity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Mimic = partdefinition.addOrReplaceChild("mimic", CubeListBuilder.create(),
				PartPose.offset(-8.0F, 16.0F, 8.0F));

		Mimic.addOrReplaceChild("top_half", CubeListBuilder.create()
						.texOffs(94, 106).addBox(7.0F, -1.0F, -16.0F, 1.0F, 1.0F, 16.0F)
						...
						.texOffs(4, 22).addBox(-6.0F, -1.0F, -15.0F, 1.0F, 2.0F, 1.0F),
				PartPose.offset(8.0F, -2.0F, 0.0F));

		PartDefinition BottomHalf = Mimic.addOrReplaceChild("bottom_half", CubeListBuilder.create()
						.texOffs(31, 86).addBox(15.0F, -2.0F, -16.0F, 1.0F, 1.0F, 16.0F)
						...
						.texOffs(0, 18).addBox(1.0F, -3.0F, -15.0F, 1.0F, 2.0F, 1.0F),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		BottomHalf.addOrReplaceChild("tongue", CubeListBuilder.create()
						.texOffs(6, 7).addBox(-2.0F, -0.5F, -9.0F, 4.0F, 1.0F, 9.0F),
				PartPose.offsetAndRotation(8.0F, -1.5F, -6.0F, -0.1745F, 0.0F, 0.0F));

		BottomHalf.addOrReplaceChild("left_feet", CubeListBuilder.create()
						.texOffs(8, 79).addBox(-1.1F, -1.0F, -0.9F, 2.0F, 4.0F, 2.0F),
				PartPose.offset(14.0F, 5.0F, -14.0F));

		BottomHalf.addOrReplaceChild("left_feet2", CubeListBuilder.create()
						.texOffs(0, 79).addBox(-0.9F, -1.0F, -1.1F, 2.0F, 4.0F, 2.0F),
				PartPose.offset(2.0F, 5.0F, -2.0F));

		BottomHalf.addOrReplaceChild("right_feet", CubeListBuilder.create()
						.texOffs(0, 72).addBox(-0.9F, 0.0F, -0.9F, 2.0F, 4.0F, 2.0F),
				PartPose.offset(2.0F, 4.0F, -14.0F));

		BottomHalf.addOrReplaceChild("right_feet2", CubeListBuilder.create()
						.texOffs(8, 72).addBox(-1.1F, -1.0F, -1.1F, 2.0F, 4.0F, 2.0F),
